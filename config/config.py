...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ramoben200-rg/Ballas",
)
...
)  # Example:- https://t.me/Ballasresmi
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @Ballasresmi
