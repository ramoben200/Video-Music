...
from BallasMusic.core.call import Yukki
from BallasMusic.misc import db
from BallasMusic.utils.database import get_authuser_names, get_cmode
from BallasMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from BallasMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Ballas.stop_stream(message.chat.id)
    except:
        pass
